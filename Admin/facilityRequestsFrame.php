...
?>
        ...
        <head>
            ...
            <link rel="stylesheet" type="text/css" href="../Admin/Styles/facilityReqsFrame.css">
            ...
            <div class = "background-blur">
                ...
                <div class="sidebar-menu">
                    <div class="blockBtn">
                        ...
                        <hr style="width:90%; text-align:center; border:1px solid #d9d9d9">
                            ...
                            <button class="btn" id="nof-button" onclick="window.location='facilityRequestsFrame.php'">Request for the Use of National Office Facility</button>
                        <hr style="width:90%; text-align:center; border:1px solid #d9d9d9">
                ...
                <div class="admin-container">
                    <div class="admin-pending-header">
                        <p class="admin-index-text">National Office Facility Requests</p>
                        <div class="admin-search-pending-request">
                            ...
                            <div class="yearContainer">
                                <select name="yearSelect" class="yearDropDown" id="yearFilter" onchange="filterByYear(this.value)">
                                    <?php 
                                        $currentYear = date("Y");
                    ...
                    <div class="tableContainer">
                        <table class="pendingRequestSummary" id="pendingTable">
                            ...
                            <tbody>
                                <?php
                                    $select = "SELECT * FROM facility_reservation 
                                        ...
                                        foreach($rows as $row){
                                            if (strtotime($row['reservation_date']) < strtotime(date('Y-m-d'))) {
                                                if ($row['status'] == 'Pending') {
                                                    $update = "UPDATE facility_reservation 
                                                            SET [status] = 'Lapsed' 
                                ...
                                ?>
                                            <tr onclick="window.location.href = 'nof_Frame.php?request_id=<?php echo $row['request_id']; ?>'">
